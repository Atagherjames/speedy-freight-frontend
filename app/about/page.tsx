...
const about: React.FC = () => {
  return (
    <div>
      ...
      />
      <div className='flex w-[55%] leading-10 justify-between ml-auto mr-auto align-center gap-4 mt-20'>
        ...
        <div className='grid grid-cols-1 gap-4'>
          <div className='flex items-center w-[400px] space-x-4 rounded-md border z-40 p-4 bg-white-1'>
      ...
      <section className='my-32 grid place-items-center'>
        ...
        <Card className='w-[70%] my-8 py-10'>
          <CardContent className='grid grid-cols-3 place-items-center gap-8'>
            <div className='cursor-pointer border-2 border-blue-1 rounded p-2 h-[300px] grid place-items-center w-[300px]'>
              <span>
      ...
      <section className='flex h-[500px] justify-center items-center'>
        <div
      ...
      <section className='grid place-items-center bg-slate-100 mt-20 py-[5rem] h-auto'>
